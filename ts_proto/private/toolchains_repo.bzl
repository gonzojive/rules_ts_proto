...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_github_gonzojive_rules_ts_proto//ts_proto:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.ts_protoinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@com_github_gonzojive_rules_ts_proto//ts_proto:toolchain_type"],
...
# By default all these toolchains are registered by the ts_proto_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:ts_proto_toolchain",
    toolchain_type = "@com_github_gonzojive_rules_ts_proto//ts_proto:toolchain_type",
)
""".format(
            platform = platform,
